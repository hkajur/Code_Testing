...
public class InstructorExamSqlDatabase extends SQLiteOpenHelper{
	...
	//Initialize class 
	public InstructorExamSqlDatabase(Context context) {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.w(InstructorExamSqlDatabase.class.getName(),
